...
DROP TABLE IF EXISTS PERIOD_PROGRAM;
DROP TABLE IF EXISTS PROGRAM;
DROP TABLE IF EXISTS PROGRAM_COMPETENCE;
...
(
   ...
   PRIMARY KEY (ENVIRONMENT_ID, TEACHER_ID, PERIOD_ID, SCHEDULE_DAY, SCHEDULE_START_TIME)
);
...
/* Table: PERIOD_PROGRAM */
CREATE TABLE PERIOD_PROGRAM
(
   PERIOD_ID           NUMERIC(8,0) NOT NULL,
   PROGRAM_ID          NUMERIC(8,0) NOT NULL,
   PRIMARY KEY (PERIOD_ID, PROGRAM_ID)
);
...
ALTER TABLE PERIOD_PROGRAM ADD CONSTRAINT FK_PERIOD_PROGRAM_PERIOD FOREIGN KEY (PERIOD_ID)
      REFERENCES ACADEMIC_PERIOD (PERIOD_ID) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE PERIOD_PROGRAM ADD CONSTRAINT FK_PERIOD_PROGRAM_PROGRAM FOREIGN KEY (PROGRAM_ID)
      REFERENCES PROGRAM (PROGRAM_ID) ON DELETE RESTRICT ON UPDATE RESTRICT;
